		...
		<section>
			<div className="container">
				...
				<button
					...
					className="xs:gap-2 relative mx-auto my-6 grid w-full grid-cols-2 items-center justify-center rounded-2xl bg-greyscale-50 p-1 sm:max-w-[286px] lg:my-11"
				>
					<span
						className={`xs:h-[48px] absolute left-1 top-[4px] z-0 flex h-[76px] w-1/2 items-center justify-center rounded-xl bg-white transition-all ${isYearly && '!left-1/2 -ml-1'}`}
					/>

					<p className="relative z-0 px-6 py-3 text-center font-semibold leading-normal text-greyscale-950">
						Monthly
					</p>
					<p className="xs:flex-row z-0 flex flex-col justify-center gap-1 px-6 py-3 text-center font-semibold leading-normal text-greyscale-950">
						Yearly
				...
				<div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
					...
					<div className="rounded-2xl border border-greyscale-100 p-4 md:p-6">
						...
						<a
							href="/"
							className="btn btn-outline flex max-w-full justify-center text-center"
						>
							Upgrade Now
						</a>
					...
					<div className="rounded-2xl border border-primary-950 bg-primary-950 p-4 md:p-6">
						...
						<a
							href="/"
							className="btn btn-primary flex max-w-full justify-center border-transparent text-center"
						>
							Upgrade Now
						</a>
